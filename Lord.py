...
def run_rustscan(subdomains, output_dir):
    ...
    rustscan_cmd = f"rustscan -a {output_dir}/sorted_subdomains.txt --ulimit 10000 | tee {output_dir}/rustscan_output.txt"
...
def prompt_tool_choice(timeout=10):
    ...
    if choice in ('1', '2', '3', '4', '5'):
        ...
        print("Invalid choice. Auto-selecting option 5 (None/Exit).")
        return '5'
